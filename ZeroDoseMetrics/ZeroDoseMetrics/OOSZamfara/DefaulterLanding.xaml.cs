...
{	
	public partial class DefaulterLanding : ContentPage
	{
        Login isExist;
        DefaulterList localDBRecord;
        ...
        public DefaulterLanding ()
		{
			InitializeComponent ();
            isExist = new Login();
            localDBRecord = new DefaulterList();
        ...
        void loginButton_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                using (SQLiteConnection conn = new SQLiteConnection(App.DatabaseLocation))
                {
                    ...
                    if (isExist != null)
                    {
                        Navigation.PushAsync(new DefaulterLinlistPage(model));
                    }
                    else
                    {
                        //else create user
